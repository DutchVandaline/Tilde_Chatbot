...
def main():
    batch_size = 16
    num_classes = 5
    root_dir = "/home/junha/Tilde_Chatbot/Dataset_Exposed_Tokenized"
    class_names_dir = os.path.join(root_dir, "Train")
    model_checkpoint = "/home/junha/Tilde_Chatbot/Module/Models/5_Class_Classification_epoch_15.pth"
